...
jest.mock("./ReaderToolbar", () => ({
  __esModule: true,
  default: ({ toggleSettings, showSettings, handleClose, handleMarkdownDownload, toggleAutoScroll, isAutoScrolling, toggleFullscreen, isFullscreen }: any) => (
    <div data-testid="reader-toolbar">
      ...
      <button onClick={handleMarkdownDownload} data-testid="download-markdown-btn">
        Download
      </button>
...
jest.mock("./SelectionToolbar", () => ({
  ...
  default: ({ onHighlight, onRemoveHighlight, onCopy, onClose }: any) => (
    <div data-testid="selection-toolbar">
      ...
      <button onClick={() => onRemoveHighlight("id")} data-testid="remove-highlight-btn">
        Remove
      </button>
