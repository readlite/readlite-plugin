  ...
  return (
    <section className={sectionClassName}>
      ...
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs w-5 text-center font-medium text-ink/70">
          A
        </span>
        <input
          type="range"
        ...
        />
        <span className="text-base w-5 text-center font-medium text-ink/70">
          A
        </span>
      </div>
      ...
      {/* Size indicators */}
      <div className="flex justify-between px-3 text-[10px] text-ink/50">
